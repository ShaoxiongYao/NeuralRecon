...
if __name__ == '__main__':
    # mesh = o3d.io.read_triangle_mesh("results/scene_demo_checkpoints_fusion_eval_47/RestAreawithPerson_mask_image_mean.ply")
    mesh = o3d.io.read_triangle_mesh("results/scene_demo_checkpoints_fusion_eval_47/LoopClosureCSL2.ply")
    ...
    # restArea visualization parameters
    # theta = np.deg2rad(15)  
    # o3d.visualization.draw_geometries([mesh], 
    #                                   zoom=0.3,
